        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            {                
                ...
                _spCollision.boolValue = EditorGUI.ToggleLeft(EditorGUI.IndentedRect(_rts_lr[0]), 
                    new GUIContent("Trick: Collision", "Removes particles when there is a collision object between the particle origin and the particle position to improve the pass-through problem. Similar to PS's Collision but slightly different result"), 
